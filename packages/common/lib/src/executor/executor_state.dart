import 'package:common/src/executor/executor_step.dart';
...
final class StepExecutorProgress<T> extends StepExecutorState<T> {
  ...
  factory StepExecutorProgress.startStep(int totalSteps, T context) => StepExecutorProgress(
    context,
    progress: 0,
  ...
  @override
  int get hashCode =>
      progress.hashCode ^ message.hashCode ^ currentStep.hashCode ^ totalSteps.hashCode ^ lastSyncTime.hashCode;
}
...
final class StepExecutorCompleted<T> extends StepExecutorState<T> {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is StepExecutorCompleted && runtimeType == other.runtimeType && context == other.context;
...
final class StepExecutorCompletedWithErrors<T> extends StepExecutorState<T> {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is StepExecutorCompletedWithErrors && runtimeType == other.runtimeType && mapEquals(errors, other.errors);
...
final class StepExecutorError<T> extends StepExecutorState<T> {
  ...
  @override
  int get hashCode => error.hashCode ^ stackTrace.hashCode ^ step.hashCode ^ context.hashCode;
}
